...
DEFAULT_ROLE_PAYLOADS = {
    ...
    "USER": {
        ...
        "attributes": {
            ...
            "ewms.levels": ["L1", "L2"],
            "ewms.dataScope": ["TEAM"],
            "ewms.modules": ["dashboard", "shipments", "documents", "tasks", "inventory", "dnd", "reports"],
    ...
    "OPS_MANAGER": {
        ...
        "attributes": {
            ...
            "ewms.levels": ["L3", "L4"],
            "ewms.dataScope": ["ALL"],
            "ewms.modules": ["dashboard", "shipments", "documents", "tasks", "inventory", "dnd", "accounting", "reports"],
            "ewms.activities": [
                "shipments.create", "shipments.view", "shipments.edit_metadata", "shipments.assign_user",
