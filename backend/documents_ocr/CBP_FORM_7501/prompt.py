"""Prompt generation for the merged CBP FORM-7501 OCR.
...
To improve extraction for a specific Entry Summary field that's coming back null
...
# when you spot LLM mis-formats in real runs of Entry Summary docs.
...
def build_cbp_form_7501_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="CBP FORM-7501")


__all__ = ["build_cbp_form_7501_prompt"]
