"""Prompt generation for CHA Bill OCR.
...
To improve extraction for a specific CHA Bill field that's coming back null
...
# when you spot LLM mis-formats in real runs of CHA Bill docs.
...
def build_cha_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="CHA Bill")


__all__ = ["build_cha_prompt"]
