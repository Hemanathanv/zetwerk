"""Prompt generation for Ocean Freight OCR.
...
To improve extraction for a specific Ocean Freight field that's coming back null
...
# when you spot LLM mis-formats in real runs of Ocean Freight docs.
...
def build_ocean_freight_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="Ocean Freight")


__all__ = ["build_ocean_freight_prompt"]
