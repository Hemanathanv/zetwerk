...
CLASSIFIER_CANDIDATES: tuple[ClassifierCandidate, ...] = (
    ...
    ClassifierCandidate("OUTWARD_GRN", "Outward GRN", "UsPackingListExtraction"),
...
CURATED_FINGERPRINTS: dict[str, tuple[str, ...]] = {
    ...
    "OUTWARD_GRN": ("outward grn", "outward packing list", "goods issue", "ship to", "sold to", "carton", "pallet"),
