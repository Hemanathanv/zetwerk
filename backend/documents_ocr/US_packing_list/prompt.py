"""Prompt generation for US Packing List OCR.
...
To improve extraction for a specific US Packing List field that's coming back null
...
# when you spot LLM mis-formats in real runs of US Packing List docs.
...
def build_us_packing_list_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="US Packing List")


__all__ = ["build_us_packing_list_prompt"]
