"""Prompt generation for Bill of Lading OCR.
...
To improve extraction for a specific Bill of Lading field that's coming back null
...
# when you spot LLM mis-formats in real runs of Bill of Lading docs.
...
def build_bill_of_lading_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="Bill of Lading")


__all__ = ["build_bill_of_lading_prompt"]
