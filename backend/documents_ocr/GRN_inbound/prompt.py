"""Prompt generation for GRN Inbound OCR.
...
To improve extraction for a specific GRN Inbound field that's coming back null
...
# when you spot LLM mis-formats in real runs of GRN Inbound docs.
...
def build_grn_inbound_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="GRN Inbound")


__all__ = ["build_grn_inbound_prompt"]
