"""Prompt generation for US Customs Release OCR.
...
To improve extraction for a specific US Customs Release field that's coming back null
...
# when you spot LLM mis-formats in real runs of US Customs Release docs.
...
def build_us_customs_release_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="US Customs Release")


__all__ = ["build_us_customs_release_prompt"]
