"""Prompt generation for Sales Invoice OCR.
...
To improve extraction for a specific Sales Invoice field that's coming back null
...
# when you spot LLM mis-formats in real runs of Sales Invoice docs.
...
def build_sales_invoice_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="Sales Invoice")


__all__ = ["build_sales_invoice_prompt"]
