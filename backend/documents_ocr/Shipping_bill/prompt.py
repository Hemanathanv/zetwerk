"""Prompt generation for Shipping Bill OCR.
...
To improve extraction for a specific Shipping Bill field that's coming back null
...
# when you spot LLM mis-formats in real runs of Shipping Bill docs.
...
def build_shipping_bill_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="Shipping Bill")


__all__ = ["build_shipping_bill_prompt"]
