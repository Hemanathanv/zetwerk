"""Prompt generation for Port to WH OCR.
...
To improve extraction for a specific Port to WH field that's coming back null
...
# when you spot LLM mis-formats in real runs of Port to WH docs.
...
def build_port_to_wh_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="Port to WH")


__all__ = ["build_port_to_wh_prompt"]
