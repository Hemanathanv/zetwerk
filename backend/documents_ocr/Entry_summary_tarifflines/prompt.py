"""Prompt generation for Entry Summary Tariff Lines OCR.
...
To improve extraction for a specific Entry Summary Tariff Lines field that's coming back null
...
# when you spot LLM mis-formats in real runs of Entry Summary Tariff Lines docs.
...
def build_entry_summary_tarifflines_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="Entry Summary Tariff Lines")


__all__ = ["build_entry_summary_tarifflines_prompt"]
