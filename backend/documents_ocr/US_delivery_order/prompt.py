"""Prompt generation for US Delivery Order OCR.
...
To improve extraction for a specific US Delivery Order field that's coming back null
...
# when you spot LLM mis-formats in real runs of US Delivery Order docs.
...
def build_us_delivery_order_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="US Delivery Order")


__all__ = ["build_us_delivery_order_prompt"]
