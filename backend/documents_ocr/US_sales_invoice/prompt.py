"""Prompt generation for US Sales Invoice OCR.
...
To improve extraction for a specific US Sales Invoice field that's coming back null
...
# when you spot LLM mis-formats in real runs of US Sales Invoice docs.
...
def build_us_sales_invoice_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="US Sales Invoice")


__all__ = ["build_us_sales_invoice_prompt"]
