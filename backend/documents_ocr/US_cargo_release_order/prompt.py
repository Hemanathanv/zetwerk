"""Prompt generation for US Cargo Release OCR.
...
To improve extraction for a specific US Cargo Release field that's coming back null
...
# when you spot LLM mis-formats in real runs of US Cargo Release docs.
...
def build_us_cargo_release_prompt(response_model: type[BaseModel]) -> str:
    return _build_dynamic_ocr_prompt(response_model=response_model, extractor_label="US Cargo Release")


__all__ = ["build_us_cargo_release_prompt"]
