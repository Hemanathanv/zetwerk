...
class CustomerBrokerBillStructuredResult(BaseModel):
...
def matches_customerbrokerbill(*, bucket: str, module: str, document: Any) -> bool:
    candidates = [
        bucket,
        module,
...
def build_prompt() -> str:
    return build_customer_broker_bill_prompt(CustomerBrokerBillStructuredResult)
...
def parse_result(payload: dict[str, Any]) -> CustomerBrokerBillStructuredResult:
    normalized = normalize_payload(payload)
    return CustomerBrokerBillStructuredResult.model_validate(normalized)


def to_prisma_data(*, result: CustomerBrokerBillStructuredResult, raw_data: dict[str, Any]) -> dict[str, Any]:
...
__all__ = [
    "CustomerBrokerBillStructuredResult",
    "ValidationError",
