  ...
  sections: [
    ...
    },
    {
      ...
      mappings: [
        ...
        { targetField: 'noOfBundles',      targetLabel: 'Bundles',        sourceDoc: 'SALES_INVOICE', sourceField: 'lineItems[].noOfPackages',     sourceLabel: 'No of Packages',  mappingType: 'conditional', transformation: 'Use from invoice if present; otherwise manual entry', validation: 'NOT NULL or flagged', validationSeverity: 'warning', mono: true, isLineItem: true },
