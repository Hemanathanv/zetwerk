  ...
  sections: [
    ...
    },
    {
      ...
      mappings: [
        ...
        { targetField: 'productMarks',     targetLabel: 'Product Marks',  sourceDoc: 'SALES_INVOICE', sourceField: 'lineItems[].productMarks',     sourceLabel: 'Product Marks',  mappingType: 'direct',      isLineItem: true },
        { targetField: 'boCode',           targetLabel: 'BO Code',        sourceDoc: 'SALES_INVOICE', sourceField: 'lineItems[].boCode',           sourceLabel: 'BO Code',        mappingType: 'direct',      mono: true, isLineItem: true },
