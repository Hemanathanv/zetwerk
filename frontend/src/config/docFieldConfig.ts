  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'shipmentReferenceNumber', label: 'Shipment Reference', mono: true, critical: true },
        ...
        { key: 'issuanceDate', label: 'Issuance Date', mono: true, critical: true },
        { key: 'issuancePlace', label: 'Issuance Place', critical: true },
    ...
    },
    {
      ...
      fields: [
        { key: 'carrierCompanyName', label: 'Carrier Name', critical: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'consigneeName', label: 'Consignee Name', critical: true },
        { key: 'consigneeAddress', label: 'Consignee Address' },
        { key: 'consigneeContactName', label: 'Consignee Contact', critical: true },
        { key: 'consigneePhone', label: 'Phone', mono: true },
        { key: 'consigneeEmail', label: 'Email', critical: true },
        { key: 'notifyPartyName', label: 'Notify Party', critical: true },
        { key: 'notifyPartyAddress', label: 'Notify Address' },
        { key: 'notifyPartyEmail', label: 'Notify Party Email', critical: true },
        { key: 'secondNotifyName', label: 'Second Notify', critical: true },
        { key: 'deliveryAgentName', label: 'Delivery Agent', critical: true },
    ...
    },
    {
      sectionLabel: 'Route',
      fields: [
        { key: 'placeOfAcceptance', label: 'Place of Acceptance', critical: true },
        { key: 'portOfLoading', label: 'Port of Loading', critical: true },
        { key: 'placeOfReceipt', label: 'Place of Receipt', critical: true },
        { key: 'countryOfOrigin', label: 'Country of Origin', critical: true },
        { key: 'portOfDischarge', label: 'Port of Discharge', critical: true },
        { key: 'finalDestination', label: 'Final Destination', critical: true },
        { key: 'placeOfDelivery', label: 'Place of Delivery', critical: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'vesselVoyageNumber', label: 'Voyage Number', mono: true, critical: true },
        { key: 'shippedOnBoardDate', label: 'Shipped on Board Date', mono: true, critical: true },
    ...
    },
    {
      sectionLabel: 'Cargo',
      fields: [
        { key: 'marksAndNumbers', label: 'Marks & Numbers', critical: true },
        { key: 'packageSummary', label: 'Package Summary', critical: true },
        { key: 'totalPackages', label: 'Total Packages', mono: true, critical: true },
        { key: 'totalContainers', label: 'Total Containers', mono: true, critical: true },
        { key: 'goodsDescription', label: 'Goods Description', critical: true },
        { key: 'grossWeight', label: 'Gross Weight', mono: true, critical: true },
        { key: 'grossWeightUnit', label: 'Gross Weight Unit', critical: true },
        { key: 'netWeight', label: 'Net Weight', mono: true, critical: true },
        { key: 'netWeightUnit', label: 'Net Weight Unit', critical: true },
        { key: 'measurementCbm', label: 'Measurement (CBM)', mono: true },
        { key: 'usHsnc', label: 'US HS Code', mono: true, critical: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'exportInvoiceDate', label: 'Export Invoice Date', mono: true, critical: true },
        { key: 'exportShippingBillNumber', label: 'Shipping Bill Number', mono: true, critical: true },
        { key: 'exportShippingBillDate', label: 'Shipping Bill Date', mono: true, critical: true },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'sbDate', label: 'SB Date', mono: true, critical: true },
        { key: 'portCode', label: 'Port Code', mono: true, critical: true },
        { key: 'portName', label: 'Port Name' },
        { key: 'iecBr', label: 'IEC/BR', mono: true, critical: true },
        { key: 'gstinType', label: 'GSTIN Type' },
        { key: 'cbCode', label: 'CB Code', mono: true, critical: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'portOfLoading', label: 'Port of Loading', critical: true },
        { key: 'portOfDischarge', label: 'Port of Discharge', critical: true },
        { key: 'countryOfFinalDest', label: 'Country of Final Destination', critical: true },
      ],
    },
    {
      sectionLabel: 'Cargo Summary',
      fields: [
        { key: 'grossWeightKgs', label: 'Gross Weight (kg)', mono: true, critical: true },
        { key: 'pkgCount', label: 'Package Count', mono: true, critical: true },
        { key: 'invCount', label: 'Invoice Count', mono: true, critical: true },
        { key: 'itemCount', label: 'Item Count', mono: true, critical: true },
...
export const DOC_FIELD_CONFIG: Record<string, DocTypeConfig> = {
  ...
  OCEAN_FREIGHT,
  ENTRY_SUMMARY,
  DRAFT_CBP_FORM_7501_BROKER: { ...ENTRY_SUMMARY, docType: 'DRAFT_CBP_FORM_7501_BROKER', displayName: 'Draft CBP FORM 7501_Broker' },
