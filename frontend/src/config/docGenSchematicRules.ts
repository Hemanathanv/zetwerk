  ...
  sections: [
    ...
    },
    {
      ...
      mappings: [
        ...
        { targetField: 'lineItems[].noOfBundles', targetLabel: 'No of Bundles', sourceDoc: 'SALES_INVOICE', sourceField: 'lineItems[].noOfPackages', sourceLabel: 'No of Packages', mappingType: 'conditional', transformation: 'IF noOfPackages exists THEN use it; ELSE IF kindOfPkg parseable THEN extract count; ELSE MANUAL', validation: 'NOT NULL or flagged manual', validationSeverity: 'warning', mono: true },
