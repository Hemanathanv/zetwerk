...
DOC_TITLE = "US Sales Invoice"
SCHEMA_PATH = Path("data/schemas/us-sales-invoice.json")
PROMPT_TS = Path("src/prompts/us-sales-invoice-structured-prompt.ts")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output",
        default="data/us_sales_invoice_ocr_output.xlsx",
    ...
    with pd.ExcelWriter(out_path, engine="openpyxl") as writer:
        df.to_excel(writer, sheet_name="US Sales Invoice", index=False)
