...
DOC_TITLE = "US Cargo Release Order"
SCHEMA_PATH = Path("data/schemas/us-cargo-release.json")
PROMPT_TS = Path("src/prompts/us-cargo-release-structured-prompt.ts")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output",
        default="data/us_cargo_release_order_ocr_output.xlsx",
    ...
    with pd.ExcelWriter(out_path, engine="openpyxl") as writer:
        df.to_excel(writer, sheet_name="US CARGO RELEASE", index=False)
