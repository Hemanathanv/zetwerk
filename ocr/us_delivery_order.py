...
DOC_TITLE = "US Delivery Order"
SCHEMA_PATH = Path("data/schemas/us-delivery-order.json")
PROMPT_TS = Path("src/prompts/us-delivery-order-structured-prompt.ts")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output",
        default="data/us_delivery_order_ocr_output.xlsx",
    ...
    with pd.ExcelWriter(out_path, engine="openpyxl") as writer:
        df.to_excel(writer, sheet_name="US DELIVERY ORDER", index=False)
