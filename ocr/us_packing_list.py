...
DOC_TITLE = "US Packing List"
SCHEMA_PATH = Path("data/schemas/us-packing-list.json")
PROMPT_TS = Path("src/prompts/us-packing-list-structured-prompt.ts")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output",
        default="data/us_packing_list_ocr_output.xlsx",
    ...
    with pd.ExcelWriter(out_path, engine="openpyxl") as writer:
        df.to_excel(writer, sheet_name="US PACKING LIST", index=False)
